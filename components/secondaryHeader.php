<nav class="secondary-header mb-6 mx-6">
    ...
    <button class="icon-button" aria-label="Settings" onclick="settingsClicked()">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-settings-icon lucide-settings">
